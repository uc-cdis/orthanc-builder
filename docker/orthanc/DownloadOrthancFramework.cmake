...
if (ORTHANC_FRAMEWORK_SOURCE STREQUAL "archive" OR
  ...
  if (NOT IS_DIRECTORY "${ORTHANC_ROOT}")
    ...
    if ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Windows")
      ...
      execute_process(
        COMMAND sh -c "sed -i 's/message(FATAL_ERROR \"The package was not uncompressed at the proper location. Check the CMake instructions.\")/execute_process(COMMAND ls . OUTPUT_VARIABLE LS_OUTPUT OUTPUT_STRIP_TRAILING_WHITESPACE);message(FATAL_ERROR \"The package was not uncompressed at the proper location ${TargetDirectory}. Check the CMake instructions. ${LS_OUTPUT}\")/g' Orthanc-1.12.2/OrthancFramework/Resources/CMake/DownloadPackage.cmake"
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
        RESULT_VARIABLE Failure
        )
    endif()
